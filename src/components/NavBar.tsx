...
const navLink = [{ title: "About", path: "#about" }, { title: "Portfolio", path: "#portfolio" }]
...
export default function NavBar() {
    ...
    return (
        <div className="text-white/70 pt-6">
                ...
                <ul className="flex flex-row p-4 space-x-8">
                    ...
                    <li>
                        <a href="#contact" className="group">
                            <h1 className="text-lg font-bold test-white/70 cursor-pointer">Contact Me</h1>
            ...
            <div onClick={toggleNav} className="md:hidden absolute top-5 right-5 border-rounded border-white/70 p-2 z-50 text-white/70">{nav ? <AiOutlineClose size={30} /> : <AiOutlineMenu size={30} />}</div>
